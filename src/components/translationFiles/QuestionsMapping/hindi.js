const hindi= {
  Section1: {
    ...
    "1.3": {
      "number": 1.3,
      "question": "प्राप्‍त की गई शिक्षा?",
      "type": "radio",
      "options": [
        {
          "label": "अशिक्षित",
    ...
    {
      "label": "चहा-शॉप/ढाबा मालक, नाभिक, दुकान येथे काम करणे, रस्त्याच्या कडेला मेकॅनिक, साइटवर काम करणे",
      "code": "3"
    },
    {
    ...
    {
      "label": "वह व्यक्ति जिसने आई टेस्ट किया था",
      "code": "4"
    },
    {
      "label": "वह व्यक्ति जिसने रैंडम ब्‍लड शुगर की जाँच की थी यदि डॉक्टर के द्वारा जाँच नहीं की गई",
      "code": "5"
    },
    {
    ...
    "6.1": {
      ...
      "options": [
        {
          "label": "10 मिनट से कम 10 1 10-15 मिनट 2 15-30 मिनट 3 30-45 मिनट 4 45 मिनट – 1 घंटा 5 1 घंटे से ज्‍यादा 6",
          "code": ""
        }
      ],
    ...
    "6.2": {
      "number": 6.2,
      "question": "क्या क्लीनिक में लैब टेस्टिंग के लिए एक अलग जगह थी?  ",
      "type": "radio",
      "options": [
        {
          "label": "हाँ",
    ...
    "6.4": {
      "number": 6.4,
      "question": "क्या फार्मासिस्ट/लैब टेकनीशियन ने खून की जांच के दौरान अपने हाथ धोये थे?",
      "type": "radio",
      "options": [
        {
    ...
    "7.2": {
      "number": 7.2,
      "question": "आपके अनुसार फार्मासिस्ट का कुलमिलाकर व्यवहार कैसा था?",
      "type": "radio",
      "options": [
        {
    ...
    "7.4": {
      "number": 7.4,
      "question": "क्या आपको दवा की खुराक के बारे में बताया गया था? ",
      "type": "radio",
      "options": [
        {
          "label": "हाँ",
    ...
    "8.4": {
      "number": 8.4,
      "question": "क्या क्‍लीनिक के परिसर के अंदर मरीजों के लिए बैठने की व्यवस्था/वेटिंग रूम था ",
      "type": "radio",
      "options": [
        {
          "label": "हाँ",
