...
//  audio: true
    ...
    Q4: {
      ...
      //true or false if the question is first in the section
    ...
    Q10: {
      ...
      placeHolder: "",
      label: "",
      options: [  //todo  continue only otherwise terminate
        "Bathing soap bar",
        "Body wash ",
      ...
      // maxSelections:"0",
      radioInput: " false",
      terminationCodes:["1"] // if given radio along with input box 
    },
    ...
    //todo added one more option by user as if none of soap id is given in the following options
    Q17: {
      number: "S8a",
 ...
 FREQUENCIES : [
    ...
    Q4: {
      number: "CS1",
      question: "Overall, how much do you like or dislike your current soap __(MENTION THE CURRENTLY USED SOAP FROM S9C) bar? Answer using the 5-point scale, where 5 means ‘Liked it very much’ & 1 means ‘Disliked it very much’? SINGLE CODE ",
      
      STATEMENTS: [
        { id: 'CS1_a', label: 'Shape of the soap is  just right' },
      ...
      lableOptions: ["Liked it very much", "Somewhat like", "Neutral", "Somewhat disliked", "Disliked it very much"],
